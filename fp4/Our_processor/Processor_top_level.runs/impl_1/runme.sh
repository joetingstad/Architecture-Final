...
HD_PWD='C:/Users/Jonathan/Desktop/fp8/fp4/Our_processor/Processor_top_level.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_sim.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor_sim.tcl -notrace
