...
HD_PWD='C:/Users/Jonathan/Desktop/fp8/fp4/Our_processor/Processor_top_level.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_sim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_sim.tcl
